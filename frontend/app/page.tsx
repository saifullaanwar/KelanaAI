...
export default function Home() {
  ...
  /* =========================================================
     Reset scroll ketika itinerary baru berhasil dibuat
     ========================================================= */
  useEffect(() => {
  ...
  /* =========================================================
     Ambil kembali draft trip setelah user login
     ========================================================= */
  useEffect(() => {
    const savedDraft = sessionStorage.getItem("kelanaai_trip_draft");
    ...
    try {
      ...
      if (draft.travelStyle) {
        setTravelStyle(draft.travelStyle);
      }

      sessionStorage.removeItem("kelanaai_trip_draft");
    } catch {
      sessionStorage.removeItem("kelanaai_trip_draft");
    }
  }, []);
  ...
  async function handleSubmit(
    ...
    try {
      ...
      /* -----------------------------------------------------
         BELUM LOGIN
         Simpan form → tampilkan modal login
         ----------------------------------------------------- */
      if (!token) {
      ...
      if (res.status === 401 || res.status === 403) {
        ...
        /* Simpan kembali data supaya tidak hilang */
        sessionStorage.setItem(
          "kelanaai_trip_draft",
          JSON.stringify({
            destination,
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#050816] text-white">
        ...
        <div className="relative z-10 mx-auto grid min-h-[calc(100dvh-64px)] max-w-7xl grid-cols-1 items-center gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[1fr_480px] lg:gap-10 lg:px-8 lg:py-0">
          ...
          <section className="flex flex-col justify-center">
            ...
            <p className="mt-5 max-w-lg text-base leading-7 text-slate-400 sm:text-lg">
              Tell KelanaAI where you want to go, your budget,
              and travel style. We&apos;ll craft a personalized
          ...
          <section className="flex justify-center lg:items-center lg:justify-end lg:py-8">
            ...
            <div className="glass glow relative flex w-full max-w-[500px] flex-col overflow-hidden rounded-[28px] p-5 shadow-2xl shadow-black/50 sm:p-6 lg:max-h-[calc(100dvh-100px)]">
                ...
                <div className="relative flex min-h-0 flex-1 flex-col">
                  ...
                  <div className="shrink-0">
                    ...
                    <p className="mt-1.5 text-sm leading-6 text-slate-400">
                      Share a few details and let KelanaAI
                      build your trip.
                    </p>
                  </div>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-slate-950/60 p-4 sm:p-5">
                      ...
                      <div className="mb-4 grid grid-cols-3 divide-x divide-white/10 overflow-hidden rounded-xl border border-white/10 bg-white/[0.03]">
                        ...
                        {[
                          ...
                          {
                            label: "Daily",
                            value: `$${trip.daily_budget.toLocaleString(
                              undefined,
                              {
              ...
              {/* =====================================================
                  ...
                  PENTING:
                  Modal berada DI LUAR {!trip ? ... : ...}
                  sehingga bisa muncul ketika trip masih null.
                  ===================================================== */}

              {showLoginPrompt && (
                <div className="absolute inset-0 z-50 flex items-center justify-center bg-[#050816]/80 p-5 backdrop-blur-sm">

                  <div className="w-full max-w-sm rounded-2xl border border-slate-700/80 bg-slate-900 p-6 shadow-2xl shadow-black/50">
                    ...
                    <div className="space-y-3">
                      ...
                      <Link
                        href="/login"
                        className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-5 py-3 font-semibold text-white shadow-lg shadow-cyan-500/20 transition hover:scale-[1.01]"
                      >
                        Login
                      ...
                      <Link
                        href="/register"
                        className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-5 py-3 font-medium text-slate-200 transition hover:border-cyan-400/30 hover:bg-cyan-400/[0.07] hover:text-white"
                      >
                        Create an Account
                      </Link>
                    ...
                    <p className="mt-4 text-center text-xs text-slate-500">
                      Your trip details will be kept while
                      you login.
                    </p>
      ...
      <footer className="relative z-20 border-t border-white/[0.08] bg-[#050816]/30 backdrop-blur-2xl">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-6 sm:flex-row">
            ...
            <p className="text-xs text-slate-600">
              &copy; {new Date().getFullYear()} KelanaAI.
              All rights reserved.
            </p>
